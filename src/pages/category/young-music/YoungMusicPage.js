...
// Nhạc trẻ
const YoungMusic = ({ dispatch, song }) => {
  ...
  useEffect(() => {
    dispatch({
      ...
      payload: {
        ...pagination,
        genre: MUSIC_GENRE.YOUNG_MUSIC,
      },
    })
  }, [pagination.current])
  return (
    <>
      <Helmet title="Nhạc trẻ karaoke" />
      <SearchForm />
      <div style={{ width: '80%', margin: 'auto' }}>
        <Card
          loading={song.loading}
          title={<h3 style={{ fontWeight: 'bold' }}>NHẠC TRẺ KARAOKE</h3>}
        >
...
export default connect(mapStateToProps)(YoungMusic)
