...
// Nhạc thiếu nhi
const ChildrenMusic = ({ dispatch, song }) => {
  ...
  useEffect(() => {
    dispatch({
      ...
      payload: {
        ...pagination,
        genre: MUSIC_GENRE.CHILDREN_MUSIC,
      },
    })
  }, [pagination.current])
  return (
    <>
      ...
      <div style={{ width: '80%', margin: 'auto' }}>
        <Card
          ...
          title={<h3 style={{ fontWeight: 'bold' }}>NHẠC THIẾU NHI KARAOKE</h3>}
        >
...
export default connect(mapStateToProps)(ChildrenMusic)
